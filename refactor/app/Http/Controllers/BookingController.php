...
class BookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->__authenticatedUser->user_type == env('ADMIN_ROLE_ID') || $request->__authenticatedUser->user_type == env('SUPERADMIN_ROLE_ID')){
            return response($this->repository->getAll($request)); // If the condition is true the request will return from here, and the code will not traverse more which saves time and memory as well.
        }
